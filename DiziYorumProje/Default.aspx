                        ...
                        <ItemTemplate>
                            <div class="content-grid">
                                <div class="content-grid-info">
                                    ...
                                    <div class="post-info">
                                        <h4><a href="BlogDetay.aspx?BLOGID=<%# Eval("ID") %>"><%# Eval("BLOGBASLIK") %></a>  <%# Eval("BLOGTARIH") %></h4>
                                        <p>
                                            <%# Eval("BLOGICERIK") %>
                                        </p>
                    ...
                    <div class="recent">
                        ...
                        <ul>
                            <asp:Repeater ID="Repeater2" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <a href="BlogDetay.aspx?BLOGID=<%# Eval("ID") %>"><%# Eval("BLOGBASLIK") %></a>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                        ...
                        <asp:Repeater ID="Repeater4" runat="server">
                            <ItemTemplate>
                                <ul>
                                    <li>
                                        <a href="#">
                                            <%# Eval("KULLANICIAD") %> - <%# Eval("YORUMICERIK") %>
                                        </a>
                                    </li>
                                </ul>
                            </ItemTemplate>
